    ...
    async function getMovieDetails() {
      ...
      try {
        const response = await fetch(
          `https://api.themoviedb.org/3/search/movie?api_key=${API_KEY}&query=${query}&language=${language}&page=${page}&append_to_response=credits`,
        );
          ...
          <div className="row">
            ...
            {loadedMovie && (
              <>
                ...
                <p>Orijinal Dil: {loadedMovie.original_language}</p>
